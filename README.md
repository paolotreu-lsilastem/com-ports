...
L'output e' un singolo oggetto JSON nel formato:
...
- La publish `win-x64` puo' richiedere runtime pack Windows disponibili localmente o accesso alla rete, a seconda dell'ambiente di build.
